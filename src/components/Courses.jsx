		...
		<div id="courses">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 max-w-screen-lg px-6 md:mx-auto gap-5 py-10 ">
				{cursos.map((curso) => (
					<div
						key={curso.id}
						className="w-full flex flex-col justify-between shadow-md text-white bg-black/50 p-8 rounded-2xl gap-4 cursor-default"
					>
						<img
						...
						<a
							...
							target="_blank"
							rel="noreferrer"
							className="font-light bg-green-700 shadow-xl mx-auto ml-0 px-4 py-2 rounded-lg hover:scale-105 ease-in duration-300 text-white "
						>
							Mas Informacion
						</a>
					</div>
