        ...
        <div className="h-auto md:max-h-auto lg:max-w-screen-lg flex flex-col md:flex-row md:gap-5 bg-emerald-400/40 w-[80vw] mx-auto rounded-lg">
            ...
            <div className="w-full px-6 md:py-6">
                ...
                <div className="flex flex-col gap-2 text-gray-100 font-thin pb-5">
                    ...
                    <p className="">A los 20 años decidí tomar una pausa de mis estudios pedagógicos y viajar por el continente Latino. Llegué a Argentina y de aquí no me fui nunca más, me casé y ahora trabajo como profesor de italiano privado. </p>
                    ...
                    <p className="">
                    Mi trabajo nació un poco antes de la pandemia, de la pasión por enseñar y, por supuesto, del buen manejo del idioma; como enseñante particular de italiano mi meta es enseñar ese idioma de manera personalizada adaptándome a las exigencias de mis alumnos, seas que ellos quieran aprender cositas básicas para comunicarse, aprender lo esencial para ir de turista, aprender desde cero e ir de a poco aumentando el manejo del idioma hasta niveles más altos, hacer conversaciones y mucho más 
                    </p>
                </div>
            </div>
        </div>
